...
void CEntity3D::SetHealth(const int bhealth)
{
	this->health = bhealth;
}
void CEntity3D::SetRender(const bool rendering)
{
	this->renderMinimap = rendering;
}
...
const int CEntity3D::GetHealth(void) const
{
	return health;
}
const bool CEntity3D::GetRender(void) const
{
