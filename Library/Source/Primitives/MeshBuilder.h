...
class CMeshBuilder
{
	public:
		...
		static CMesh* GenerateSphere(glm::vec4 color, unsigned numStacks, unsigned numSlices, float radius);
		//static CMesh* GenerateQuad(glm::vec4 color, float lengthX, float lengthY);
};
