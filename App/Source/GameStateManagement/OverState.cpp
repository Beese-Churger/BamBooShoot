 ...
 */
bool COverState::Init(void)
{
	cout << "COverState::Init()\n" << endl;

	CShaderManager::GetInstance()->Use("Shader2D");
	//CShaderManager::GetInstance()->activeShader->setInt("texture1", 0);

	//Create Background Entity
	background = new CBackgroundEntity("Image/OverBackground.png");
	...
	startButtonData.fileName = "Image\\GUI\\ReplayButton.png";
 ...
 */
bool COverState::Update(const double dElapsedTime)
{
...
void COverState::Render(void)
{
	...
	//cout << "COverState::Render()\n" << endl;
}

/**
 @brief Destroy this class instance
 */
void COverState::Destroy(void)
{
	// Disable the cursor
	if (CSettings::GetInstance()->bDisableMousePointer == true)
