...
public:
	...
	virtual void SetSpread(const int spread);
	virtual int GetSpread(void) const;

	virtual void SetAim(const bool aiming);
	virtual bool GetAim(void) const;

	virtual void SetAuto(const bool isAuto);
	virtual bool GetAuto(void) const;

	virtual void SetRecoil(const glm::vec2);
	virtual glm::vec2 GetRecoil(void) const;
