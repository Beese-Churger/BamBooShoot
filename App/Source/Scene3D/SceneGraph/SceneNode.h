...
public:
	...
	bool Init(void);
	bool InitModel(const std::string modelname, const std::string tex);
	// Set model
	...
	void CheckandLoadModel(const std::string model, const std::string tex);
	...
	//bool bIsDisplayed;
	CSceneNode::TYPE typeofscenegraph;
	CSceneNode* cHeadNode;
protected:
