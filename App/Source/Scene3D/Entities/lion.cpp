 ...
 */
CLion::CLion(	const glm::vec3 vec3Position,
...
bool CLion::Init(void)
{
	...
	{
		if (LoadModelAndTexture("Models/jap/Lion/Lion.obj", 
								"Models/jap/Lion/Lion_H.png",
	...
	else
	{
		...
		if (LoadModelAndTexture("Models/jap/Lion/Lion_M.obj",
								"Models/jap/Lion/Lion_M.png",
								arrVAO[1], arriTextureID[1], arrIndicesSize[1]) == false)
		{
			cout << "Unable to load mid LOD model and texture" << endl;
		}
		if (LoadModelAndTexture("Models/jap/Lion/Lion_L.obj",
								"Models/jap/Lion/Lion_L.png",
 ...
 */
bool CLion::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void CLion::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CLion::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CLion::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool CLion::Update(const double dElapsedTime)
{
...
/**
 @brief Print Self
 */
void CLion::PrintSelf(void)
{
	cout << "CLion::PrintSelf()" << endl;
	cout << "========================" << endl;
}
