...
bool CTreeKabak3D::Init(void)
{
	...
	std::string file_path = "Models/Trees/Blossom/SpruceTree.obj";
	...
	iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Models/Trees/Blossom/SpruceTree.tga", false);
	if (iTextureID == 0)
	{
