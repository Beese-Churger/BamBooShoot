 ...
 */
CShrine::CShrine(	const glm::vec3 vec3Position,
...
bool CShrine::Init(void)
{
	...
	{
		if (LoadModelAndTexture("Models/jap/Shrine/Shrine.obj", 
								"Models/jap/Shrine/Shrine_H.png",
 ...
 */
bool CShrine::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void CShrine::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CShrine::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CShrine::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool CShrine::Update(const double dElapsedTime)
{
...
/**
 @brief Print Self
 */
void CShrine::PrintSelf(void)
{
	cout << "CShrine::PrintSelf()" << endl;
	cout << "========================" << endl;
}
