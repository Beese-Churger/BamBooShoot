 ...
 */
CTorii::CTorii(	const glm::vec3 vec3Position,
...
bool CTorii::Init(void)
{
	...
	{
		if (LoadModelAndTexture("Models/jap/Torii/Torii.obj", 
								"Models/jap/Torii/Torii_H.png",
 ...
 */
bool CTorii::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void CTorii::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CTorii::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CTorii::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool CTorii::Update(const double dElapsedTime)
{
...
/**
 @brief Print Self
 */
void CTorii::PrintSelf(void)
{
	cout << "CTorii::PrintSelf()" << endl;
	cout << "========================" << endl;
}
