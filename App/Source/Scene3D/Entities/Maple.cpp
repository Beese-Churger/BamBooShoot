 ...
 */
CMaple::CMaple(	const glm::vec3 vec3Position,
...
bool CMaple::Init(void)
{
	...
	std::string file_path = "Models/Trees/Blossom/Grass.obj";
	...
	iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Models/Trees/Blossom/Single_grass2_diffuse.tga", false);
	if (iTextureID == 0)
	{
 ...
 */
void CMaple::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CMaple::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CMaple::SetProjection(const glm::mat4 projection)
{
...
*/
void CMaple::SetInstancingMode(const bool bInstancedRendering)
{
 ...
 */
void CMaple::SetNumOfInstance(const unsigned int iNumOfInstance)
{
 ...
 */
void CMaple::SetSpreadDistance(const float fSpreadDistance)
{
 ...
 */
bool CMaple::Update(const double dElapsedTime)
{
	if (!bInstancedRendering)
	{
...
/**
 @brief Print Self
 */
void CMaple::PrintSelf(void)
{
	cout << "CMaple::PrintSelf()" << endl;
	cout << "========================" << endl;
}
