 ...
 */
CPadoga::CPadoga(	const glm::vec3 vec3Position,
...
bool CPadoga::Init(void)
{
	...
	{
		if (LoadModelAndTexture("Models/jap/Padoga/Padoga.obj", 
								"Models/jap/Padoga/Padoga_H.png",
	...
	else
	{
		...
		if (LoadModelAndTexture("Models/jap/Padoga/Padoga_M.obj",
								"Models/jap/Padoga/Padoga_M.png",
								arrVAO[1], arriTextureID[1], arrIndicesSize[1]) == false)
		{
			cout << "Unable to load mid LOD model and texture" << endl;
		}
		if (LoadModelAndTexture("Models/jap/Padoga/Padoga_M.obj",
								"Models/jap/Padoga/Padoga_L.png",
 ...
 */
bool CPadoga::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void CPadoga::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CPadoga::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CPadoga::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool CPadoga::Update(const double dElapsedTime)
{
...
/**
 @brief Print Self
 */
void CPadoga::PrintSelf(void)
{
	cout << "CPadoga::PrintSelf()" << endl;
	cout << "========================" << endl;
}
