 ...
 */
CToro::CToro(	const glm::vec3 vec3Position,
...
bool CToro::Init(void)
{
	...
	{
		if (LoadModelAndTexture("Models/jap/Toro/Toro.obj", 
								"Models/jap/Toro/Toro_H.png",
 ...
 */
bool CToro::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void CToro::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CToro::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CToro::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool CToro::Update(const double dElapsedTime)
{
...
/**
 @brief Print Self
 */
void CToro::PrintSelf(void)
{
	cout << "CToro::PrintSelf()" << endl;
	cout << "========================" << endl;
}
