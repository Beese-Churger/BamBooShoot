 ...
 */
CPine::CPine(	const glm::vec3 vec3Position,
...
bool CPine::Init(void)
{
	...
	std::string file_path = "Models/Trees/Bamboo/untitled.obj";
	...
	iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Models/Trees/Bamboo/bambooTexture.jpg", false);
	if (iTextureID == 0)
	{
 ...
 */
void CPine::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CPine::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CPine::SetProjection(const glm::mat4 projection)
{
...
*/
void CPine::SetInstancingMode(const bool bInstancedRendering)
{
 ...
 */
void CPine::SetNumOfInstance(const unsigned int iNumOfInstance)
{
 ...
 */
void CPine::SetSpreadDistance(const float fSpreadDistance)
{
 ...
 */
bool CPine::Update(const double dElapsedTime)
{
	if (!bInstancedRendering)
	{
...
/**
 @brief Print Self
 */
void CPine::PrintSelf(void)
{
	cout << "CPine::PrintSelf()" << endl;
	cout << "========================" << endl;
}
